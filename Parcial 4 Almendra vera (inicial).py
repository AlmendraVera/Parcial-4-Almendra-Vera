...
def nombre_comprador(nombre):
    return nombre == nombre not in entradas
...
def opcion_1 ():
    ...
    while True:
        codigo=input("\nIngrse codigo de confirmación (Debe tener mínimo 6 caracteres, al menos una letra mayúscula, un número y sin espacios.): ")
